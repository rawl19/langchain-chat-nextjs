...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Kuna Chat</title>
        <meta name="description" content="GPT-3 interface" />
            ...
            {messages.map((message, index) => {
              return (
                ...
                <div key={index} className={message.role === "user" && loading && index === messages.length - 1 ? styles.usermessagewaiting : message.role === "assistant" ? styles.apimessage : styles.usermessage}>
                  ...
                  {message.role === "assistant" ? <Image src="/Kuna.png" alt="AI" width="30" height="30" className={styles.boticon} priority={true} /> : <Image src="/usericon.png" alt="Me" width="30" height="30" className={styles.usericon} priority={true} />}
          ...
          <div className={styles.cloudform}>
            <form onSubmit={handleSubmit}>
              <textarea
                ...
                id="userInput"
                name="userInput"
                placeholder={loading ? "Waiting for response..." : "Escribe tu pregunta..."}
                value={userInput}
